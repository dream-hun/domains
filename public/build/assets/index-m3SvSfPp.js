...
function m(r) {
    const t = v(r),
        o = i.forwardRef((n, e) => {
            let { children: l, ...a } = n;
            y(l) && typeof c == 'function' && (l = c(l._payload));
            ...
            if (f) {
                ...
                return u.jsx(t, {
                    ...a,
                    ref: e,
                    children: i.isValidElement(p)
                        ? i.cloneElement(p, void 0, S)
                        : null,
                });
            }
            return u.jsx(t, { ...a, ref: e, children: l });
        });
...
function v(r) {
    const t = i.forwardRef((o, n) => {
        let { children: e, ...l } = o;
        if (
            (y(e) && typeof c == 'function' && (e = c(e._payload)),
            i.isValidElement(e))
        ) {
            const a = R(e),
                s = x(l, e.props);
            return (
                e.type !== i.Fragment && (s.ref = n ? g(n, a) : a),
                i.cloneElement(e, s)
            );
        }
...
function x(r, t) {
    ...
    for (const n in t) {
        ...
        /^on[A-Z]/.test(n)
            ...
            : n === 'style'
              ? (o[n] = { ...e, ...l })
              : n === 'className' && (o[n] = [e, l].filter(Boolean).join(' '));
    }
    return { ...r, ...o };
}
function R(r) {
...
var _ = [
    ...
    N = _.reduce((r, t) => {
        ...
        return ((n.displayName = `Primitive.${t}`), { ...r, [t]: n });
    }, {});
export { N as P, $ as S };
