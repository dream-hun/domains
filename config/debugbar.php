...
return [
    ...
    */
    ...
    'options' => [
        ...
        'mail' => [
            // Timeline disabled: MessageSent can use a different message instance than MessageSending,
            // causing "Failed stopping measure because it hasn't been started" (e.g. during domain registration).
            'timeline' => env('DEBUGBAR_OPTIONS_MAIL_TIMELINE', false),
