<x-admin-layout>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Hosting Plan Feature</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Hosting Plan Feature</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.hosting-plan-features.update', $hostingPlanFeature) }}" method="POST">
                            @csrf
                            @method('PUT')
                                    ...
                                    <select name="hosting_feature_id" id="hosting_feature_id"
                                        ...
                                        @foreach ($hostingFeatures as $feature)
                                            <option value="{{ $feature->id }}"
                                                {{ old('hosting_feature_id', $hostingPlanFeature->hosting_feature_id) == $feature->id ? 'selected' : '' }}>
                                                {{ $feature->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="feature_value" id="feature_value"
                                        ...
                                        value="{{ old('feature_value', $hostingPlanFeature->feature_value) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="sort_order" id="sort_order"
                                        ...
                                        value="{{ old('sort_order', $hostingPlanFeature->sort_order ?? 0) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="is_unlimited" id="is_unlimited" value="1"
                                            ...
                                            {{ old('is_unlimited', $hostingPlanFeature->is_unlimited) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="is_included" id="is_included" value="1"
                                            ...
                                            {{ old('is_included', $hostingPlanFeature->is_included ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="custom_text" id="custom_text" rows="3"
                                    ...
                                    placeholder="Override display text">{{ old('custom_text', $hostingPlanFeature->custom_text) }}</textarea>
                                @error('custom_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mt-4 d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-floppy"></i> Update Plan Feature
                                </button>
                            </div>
                        </form>
                    </div>
