<x-admin-layout>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Hosting Feature</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Hosting Feature</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.hosting-features.update', $hostingFeature) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $hostingFeature->name) }}" required>
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug"
                                        ...
                                        value="{{ old('slug', $hostingFeature->slug) }}">
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                    ...
                                    <select name="feature_category_id" id="feature_category_id"
                                        ...
                                        @foreach ($featureCategories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('feature_category_id', $hostingFeature->feature_category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="category" id="category"
                                        ...
                                        value="{{ old('category', $hostingFeature->category) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="value_type" id="value_type"
                                        ...
                                        <option value="text" {{ old('value_type', $hostingFeature->value_type) == 'text' ? 'selected' : '' }}>Text</option>
                                        <option value="unlimited" {{ old('value_type', $hostingFeature->value_type) == 'unlimited' ? 'selected' : '' }}>Unlimited</option>
                                    </select>
                                    @error('value_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="unit" id="unit"
                                        ...
                                        value="{{ old('unit', $hostingFeature->unit) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="icon" id="icon"
                                        ...
                                        value="{{ old('icon', $hostingFeature->icon) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="sort_order" id="sort_order"
                                        ...
                                        value="{{ old('sort_order', $hostingFeature->sort_order ?? 0) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="is_highlighted" id="is_highlighted" value="1"
                                            ...
                                            {{ old('is_highlighted', $hostingFeature->is_highlighted) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="form-control @error('description') is-invalid @enderror">{{ old('description', $hostingFeature->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mt-4 d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-floppy"></i> Update Feature
                                </button>
                            </div>
                        </form>
                    </div>
