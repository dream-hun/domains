<x-admin-layout>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Hosting Promotion</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('admin.hosting-promotions.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-success">
                                    <i class="bi bi-check2-circle"></i> Save Promotion
                                </button>
