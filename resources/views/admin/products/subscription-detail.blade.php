            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">Subscription Details</h3>
                        @php
                    ...
                    <div class="card-body">
                        @if($subscription->isExpiringSoon())
                            <div class="alert alert-warning">
                                ...
                                This subscription will expire on {{ $subscription->expires_at->format('F d, Y') }}.
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('admin.products.hosting') }}" class="btn btn-secondary">
                                <i class="bi bi-arrow-left"></i> Back to My Hosting
                            </a>
                            @if($subscription->canBeRenewed())
                                <form action="{{ route('admin.products.subscription.renew', $subscription) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-success">
                                        <i class="bi bi-cart-plus"></i> Add Renewal to Cart
                                    </button>
                                </form>
                            @endif
                        </div>
