...
it('converts regular currencies to cents by multiplying by 100', function () {
...
it('handles zero-decimal currencies without multiplying by 100', function () {
...
it('handles alternative currency code FRW as RWF', function () {
...
it('rounds amounts correctly', function () {
