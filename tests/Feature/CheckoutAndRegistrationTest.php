...
it(/**
 * @throws InvalidItemException
 */ 'stores checkout session data when proceeding to payment', function (): void {
    Cart::add([
        'id' => 'example.com',
        'name' => 'example.com',
        'price' => 12.99,
 ...
 * @throws InvalidItemException
 * @throws Throwable
 */ 'stores exchange rate on order items when creating order', function (): void {
    ...
    expect($orderItem->currency)->toBe('USD')
        ->and($orderItem->exchange_rate)->toBe('1.000000');
