...
class ContaboService
{
    ...
    {
        $response = $this->client()->post("/compute/instances/$instanceId/cancel", [
    ...
    {
        $response = $this->client()->post("/compute/instances/$instanceId/upgrade", $addOns);
    ...
    {
        $response = $this->client()->post("/compute/instances/$instanceId/actions/$action");
    ...
    {
        $response = $this->client()->get("/compute/instances/$instanceId/snapshots", $filters);
    ...
    {
        $response = $this->client()->get("/compute/instances/$instanceId/snapshots/$snapshotId");
    ...
    public function revertSnapshot(int $instanceId, string $snapshotId): array
    {
        ...
        $this->assertSuccess($response, "Revert instance #$instanceId to snapshot $snapshotId");
        return $response->json('data.0');
    }
    ...
    {
        $response = $this->client()->patch("/object-storages/$objectStorageId/cancel");
    ...
    {
        $response = $this->client()->get("/object-storages/$objectStorageId/stats");
    ...
    {
        $response = $this->client()->post("/private-networks/$privateNetworkId/instances", [
            'instanceId' => $instanceId,
        ]);
        $this->assertSuccess($response, "Assign instance #$instanceId to private network $privateNetworkId");
        return $response->json('data.0');
    }
    ...
    public function removeInstanceFromPrivateNetwork(string $privateNetworkId, int $instanceId): bool
    {
        ...
        $this->assertSuccess($response, "Remove instance #$instanceId from private network $privateNetworkId");
        return true;
    }
    ...
    {
        $response = $this->client()->get("/tags/$tagId/assignments", $filters);
    ...
    {
        $response = $this->client()->post("/tags/$tagId/assignments/$resourceType/$resourceId");
        $this->assertSuccess($response, "Assign tag #$tagId to $resourceType/$resourceId");
        return $response->json('data.0');
    }
    ...
    {
        $response = $this->client()->delete("/tags/$tagId/assignments/$resourceType/$resourceId");
        $this->assertSuccess($response, "Remove tag #$tagId from $resourceType/$resourceId");
        return true;
    }
    ...
    {
        $response = $this->client()->post("/users/$userId/resetPassword");
    ...
    {
        $response = $this->client()->post("/users/$userId/resendEmailVerification");
    ...
    {
        $response = $this->client()->get("/users/$userId/object-storages/credentials");
