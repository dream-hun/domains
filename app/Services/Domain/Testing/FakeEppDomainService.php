...
/**
 * Fake EPP Domain Service for testing purposes.
 * This service provides predictable responses without connecting to an actual EPP server.
 */
final class FakeEppDomainService implements DomainRegistrationServiceInterface
{
    ...
    {
        $nameservers = $this->registeredDomains[$domain]['nameservers'] ?? ['ns1.fake.rw', 'ns2.fake.rw'];
